...
print(xtable::xtable(summary(celex_m3)$coef, digits = 3, label = 'resid1', caption = 'Model 3: MGL scores and GCM residuals, baseline data'))
@

<<celex_resid2, echo=F,eval=T, results=tex>>=
load('models/si_celex_m4.rda')
print(xtable::xtable(summary(celex_m4)$coef, digits = 3, label = 'resid2', caption = 'Model 4: GCM scores and MGL residuals, baseline data'))
@
...
print(xtable::xtable(summary(indiv_m5)$coef, digits = 3, label = 'indiv1', caption = 'Model 5: Celex-GCM and individual score difference, post-test data'))

@

<<indiv_diff2, echo=F,eval=T, results=tex>>=
load('models/si_indiv_m6.rda')
print(xtable::xtable(summary(indiv_m6)$coef, digits = 3, label = 'indiv2', caption = 'Model 6: Celex-MGL and individual score difference, post-test data'))
@
