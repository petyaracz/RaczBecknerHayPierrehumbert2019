...
# add loess smooths.
p1 = ggplot(three_studies, aes(x = baseline, y = posttest, colour = co_player_lexical_typicality, shape = co_player_lexical_typicality, linetype = co_player_lexical_typicality)) +
  guides(size = F) +
  geom_point() +
