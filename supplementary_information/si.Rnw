...
# plot(effects::effect('co_player_regularisation_rate', lme.fit1), xlab = 'co-player regularization shift', ylab = 'player post-test regularization', main = 'Effect of co-player rate of regularization on pos-test responses')

# plot(effects::effect('verb_baseline_average:co_player_lexical_typicality', lme.fit1), multiline = T, lines=list(lty=c(1,2,3)), xlab = 'verb baseline average', ylab = 'player post-test regularization', main = 'Effect of co-player lexical typicality on pos-test responses')
