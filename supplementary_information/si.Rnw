...
print(xtable::xtable(lme.fit1.sum, digits = 2, label = 'regressiontable1', caption = 'Experimental Data, Post-test Regression Model Summary. Model formula: post-test regular response ~ verb baseline mean x lexical typicality + participant pretest mean + regularization shift + (1 + verb.baseline.mean | participant) + (1 | verb)'))
@
...
print(xtable::xtable(celex_m3_summary, digits = 2, label = 'resid1', caption = 'Model 3: MGL scores and GCM residuals, baseline data'))
@

<<celex_resid2, echo=F,eval=T, results=tex>>=
load('models/si_celex_m4.rda')
celex_m4_summary = niceCoefTable(celex_m4)
print(xtable::xtable(celex_m4_summary, digits = 2, label = 'resid2', caption = 'Model 4: GCM scores and MGL residuals, baseline data'))
@
...
print(xtable::xtable(indiv_m5_sum, digits = 2, label = 'indiv1', caption = 'Model 5: Celex-GCM and individual score difference, post-test data'))
...
print(xtable::xtable(indiv_m6_sum, digits = 3, label = 'indiv2', caption = 'Model 6: Celex-MGL and individual score difference, post-test data'))
@
...
print(xtable::xtable(comp_fit1_sum, digits = 2, label = 'comp3', caption = 'Celex-MGL and Individual-GCM predict variation in the post-test'))
@
