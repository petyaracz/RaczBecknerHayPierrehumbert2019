...
try(setwd('../../models/paper'))
try(setwd('~/Github/RaczBecknerHayPierrehumbert2019/models/paper'))
```
...
# reg shift: nc - -40% - +40%
lme.fit2 = glmer(resp_post_reg ~ 1 + baseline_av_z * lex_typicality + pre_reg_av_z + reg_rate +
    (1 + baseline_av_z | participant_id) + 
    (1  | word), 
  data = test2, 
...
summary(lme.fit2)
# not the same as model in paper.
