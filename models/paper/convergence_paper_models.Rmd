...
# reg shift: nc - -40% - +40%
lme.fit2 = glmer(resp_post_reg ~ 1 + baseline_av_c * lex_typicality + pre_reg_av_c + reg_rate +
    (1 + baseline_av_c | participant_id) + 
    (1  | word), 
  data = test2, 
  family = binomial (link = logit),
...
ggplot(t4, aes(x = baseline.averages, y = individual.averages, colour = lex_typicality2, shape = lex_typicality2)) +
  guides(size = F) +
  geom_point() +
  ...
  xlab('verb baseline average') +
  ylab('verb ESP average')
